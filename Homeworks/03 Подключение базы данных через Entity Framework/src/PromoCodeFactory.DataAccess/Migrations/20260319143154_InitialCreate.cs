    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Customes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerPreference_Customes_CustomersId",
                        column: x => x.CustomersId,
                        principalTable: "Customes",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerPromoCods", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerPromoCods_Customes_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerPromoCods_PromoCodes_PromoCodeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerPromoCods_CustomerId",
                table: "CustomerPromoCods",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerPromoCods_PromoCodeId",
                table: "CustomerPromoCods",
                column: "PromoCodeId");
